...
public class PetShop implements Relatorio, Calculavel {
    ...
    private void cadastrarAnimal() {
        ...
        int tipo = JOptionPane.showOptionDialog(null, "Escolha o tipo do animal:", "Cadastro", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE, null, tipos, tipos[0]);
    ...
    private void registrarServico() {
        ...
        int indice = Integer.parseInt(JOptionPane.showInputDialog("Escolha o animal:\n\n" + lista));
        Animal animal = animais.get(indice);

        String[] servicosMenu = {"Banho", "Consulta"};

        int tipoServico = JOptionPane.showOptionDialog(null, "Escolha o serviço:", "Serviços", JOptionPane.DEFAULT_OPTION, JOptionPane.INFORMATION_MESSAGE, null, servicosMenu, servicosMenu[0]);
        Servico servico = null;
        switch (tipoServico) {
            case 0:
                if (animal instanceof Passaro) {
                    JOptionPane.showMessageDialog(null, "Pássaros não podem tomar banho.");
                    return;
                }
                int duracao = Integer.parseInt(JOptionPane.showInputDialog("Duração do banho (min):"));
    ...
    private void mostrarTotal() {
        JOptionPane.showMessageDialog(null, "Total do dia: R$ " + calcularTotal());
    }
    @Override
